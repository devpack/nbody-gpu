...
void Render::Bind(std::vector<glm::vec3> vertices)
{
...
void Render::Bind()
{
	this->nb_vertices = this->particles.size();

	std::vector<glm::vec3> vertices;

	for(unsigned int i = 0; i < this->nb_vertices; i++)
	{
		vertices.push_back(particles[i].pos);
	}
